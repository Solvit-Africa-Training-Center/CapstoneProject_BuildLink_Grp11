    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('worker', 'Worker'), ('owner', 'Owner'), ('company', 'Company'), ('student', 'Student'), ('admin', 'Admin')], max_length=20)),
                ('full_name', models.CharField(max_length=255)),
                ('company_name', models.CharField(blank=True, max_length=255, null=True)),
                ('company_license', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('national_id', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user', to='core.nationalid')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.trade')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
